...
public class FinalsPanel10man extends FinalsPanel {
	/**
	 * 
	 */
	...
	private MyLabel selejt9gomb1;
	private MyLabel selejt9gomb2;
	private MyLabel selejt10gomb1;
	private MyLabel selejt10gomb2;
	...
	private JTextField selejt9Rajt;
	private JTextField selejt10Rajt;
	...
	public FinalsPanel10man(double w, double h, DontoPanel dp) {
		dpanel = dp;
				...
				public void mousePressed(MouseEvent e) {
					if (selejt7gomb1.isSelected()) {
						...
						if (selejt7gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 1, Integer.parseInt(selejt7Rajt.getText()));
							negyed1Rajt.setText(selejt7Rajt.getText());
							negyed1.setText(selejt7.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt7Rajt.getText()), 1);
						}
					}
			...
			chkSelejt1.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkSelejt1.isSelected()) {
						...
						if(!selejt7Rajt.getText().equals("")) a1 = Integer.parseInt(selejt7Rajt.getText());
						if(!selejt4Rajt.getText().equals("")) a2 = Integer.parseInt(selejt4Rajt.getText());
						if(!selejt6Rajt.getText().equals("")) b1 = Integer.parseInt(selejt6Rajt.getText());
						if(!selejt9Rajt.getText().equals("")) b2 = Integer.parseInt(selejt9Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkSelejt1.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkSelejt1.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
				...
				public void mousePressed(MouseEvent e) {
					if (!negyed1gomb2.isSelected()) {
						...
						if (negyed1gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed1Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed1Rajt.getText()), 0);
						}
					}
				}
			});
			...
			negyed1gomb2.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					if (negyed1gomb1.isSelected()) {
						...
						if (negyed1gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed1Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 2, 1, Integer.parseInt(negyed1Rajt.getText()));
							elodonto1Rajt.setText(negyed1Rajt.getText());
							elodonto1.setText(negyed1.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed1Rajt.getText()), 1);
						}
					}
				...
				public void mousePressed(MouseEvent e) {
					if (selejt6gomb1.isSelected()) {
						...
						if (selejt6gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 1, Integer.parseInt(selejt6Rajt.getText()));
							negyed1Rajt.setText(selejt6Rajt.getText());
							negyed1.setText(selejt6.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt6Rajt.getText()), 1);
						}
					}
			...
			chkNegyed1.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkNegyed1.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!negyed1Rajt.getText().equals("")) a1 = Integer.parseInt(negyed1Rajt.getText());
						if(!negyed3Rajt.getText().equals("")) a2 = Integer.parseInt(negyed3Rajt.getText());
						if(!negyed2Rajt.getText().equals("")) b1 = Integer.parseInt(negyed2Rajt.getText());
						if(!negyed4Rajt.getText().equals("")) b2 = Integer.parseInt(negyed4Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkNegyed1.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkNegyed1.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
		...
		}
		{
			...
			gbc_elodonto1Rajt.gridx = 10;
			gbc_elodonto1Rajt.gridy = 3;
				...
				public void mousePressed(MouseEvent e) {
					if (selejt4gomb1.isSelected()) {
						...
						if (selejt4gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 2, Integer.parseInt(selejt4Rajt.getText()));
							negyed2Rajt.setText(selejt4Rajt.getText());
							negyed2.setText(selejt4.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt4Rajt.getText()), 1);
						}
					}
			...
			chkElo1.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkElo1.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!elodonto1Rajt.getText().equals("")) a1 = Integer.parseInt(elodonto1Rajt.getText());
						if(!selejt2Rajt.getText().equals("")) a2 = Integer.parseInt(selejt2Rajt.getText());
						if(!selejt1Rajt.getText().equals("")) b1 = Integer.parseInt(selejt1Rajt.getText());
						if(!elodonto2Rajt.getText().equals("")) b2 = Integer.parseInt(elodonto2Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkElo1.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkElo1.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
			...
			chkSelejt2.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkSelejt2.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!selejt4Rajt.getText().equals("")) a1 = Integer.parseInt(selejt4Rajt.getText());
						if(!selejt10Rajt.getText().equals("")) a2 = Integer.parseInt(selejt10Rajt.getText());
						if(!selejt9Rajt.getText().equals("")) b1 = Integer.parseInt(selejt9Rajt.getText());
						if(!selejt3Rajt.getText().equals("")) b2 = Integer.parseInt(selejt3Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkSelejt2.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
			chkSelejt2.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
				...
				public void mousePressed(MouseEvent e) {
					if (!negyed2gomb2.isSelected()) {
						...
						if (negyed2gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed2Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed2Rajt.getText()), 0);
						}
					}
				}
			});
			...
			negyed2gomb2.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					if (negyed2gomb1.isSelected()) {
						...
						if (negyed2gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed2Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 2, 1, Integer.parseInt(negyed2Rajt.getText()));
							elodonto1Rajt.setText(negyed2Rajt.getText());
							elodonto1.setText(negyed2.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed2Rajt.getText()), 1);
						}
					}
		...
		}
		{
			...
			gbc_selejt1Rajt.gridx = 10;
			gbc_selejt1Rajt.gridy = 5;
		...
		}
		{
			...
			gbc_selejt1gomb2.gridx = 13;
			gbc_selejt1gomb2.gridy = 5;
			add(selejt1gomb2, gbc_selejt1gomb2);
		}
		{
			selejt9Rajt = new JTextField();
			selejt9Rajt.setFont(new Font("Tahoma", Font.PLAIN, 36));
			selejt9Rajt.setEditable(false);
			selejt9Rajt.setColumns(3);
			selejt9Rajt.setBorder(null);
			GridBagConstraints gbc_selejt9Rajt = new GridBagConstraints();
			gbc_selejt9Rajt.insets = new Insets(0, 0, 5, 5);
			gbc_selejt9Rajt.fill = GridBagConstraints.BOTH;
			gbc_selejt9Rajt.gridx = 0;
			gbc_selejt9Rajt.gridy = 6;
			add(selejt9Rajt, gbc_selejt9Rajt);
		}
		{
			selejt9 = new JTextField();
			selejt9.setFont(new Font("Tahoma", Font.PLAIN, 36));
			selejt9.setEditable(false);
			selejt9.setBorder(null);
			selejt9.setMaximumSize(new Dimension(200, 100));
			selejt9.setMinimumSize(new Dimension(10, 10));
			selejt9.setPreferredSize(new Dimension(100, 60));
			selejt9.setText("9");
			GridBagConstraints gbc_selejt9 = new GridBagConstraints();
			gbc_selejt9.insets = new Insets(0, 0, 5, 5);
			gbc_selejt9.fill = GridBagConstraints.BOTH;
			gbc_selejt9.ipady = (int) height / 79;
			gbc_selejt9.gridx = 1;
			gbc_selejt9.gridy = 6;
			add(selejt9, gbc_selejt9);
			selejt9.setColumns(10);
		}
		{
			selejt9gomb1 = new MyLabel("");
			selejt9gomb1.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) {
					if (!selejt9gomb2.isSelected()) {
						selejt9gomb1.setSelected();
						dpanel.switchNumbers();
						if (selejt9gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt9Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt9Rajt.getText()), 0);
						}
					}
				}
			});
			selejt9gomb1.setOpaque(true);
			selejt9gomb1.setBackground(Color.LIGHT_GRAY);
			selejt9gomb1.setBorder(null);
			selejt9gomb1.setMinimumSize(new Dimension(10, 40));
			selejt9gomb1.setMaximumSize(new Dimension(40, 80));
			selejt9gomb1.setPreferredSize(new Dimension(20, 60));
			GridBagConstraints gbc_selejt9gomb1 = new GridBagConstraints();
			gbc_selejt9gomb1.fill = GridBagConstraints.BOTH;
			gbc_selejt9gomb1.insets = new Insets(0, 5, 5, 5);
			gbc_selejt9gomb1.ipady = (int) height / 79;
			gbc_selejt9gomb1.gridx = 2;
			gbc_selejt9gomb1.gridy = 6;
			add(selejt9gomb1, gbc_selejt9gomb1);
		}
		{
			selejt9gomb2 = new MyLabel("");
			selejt9gomb2.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) {
					if (selejt9gomb1.isSelected()) {
						selejt9gomb2.setSelected();
						if (selejt9gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt9Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 1, 2, Integer.parseInt(selejt9Rajt.getText()));
							negyed2Rajt.setText(selejt9Rajt.getText());
							negyed2.setText(selejt9.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt9Rajt.getText()), 1);
						}
					}
			...
			selejt9gomb2.setOpaque(true);
			selejt9gomb2.setBackground(Color.LIGHT_GRAY);
			selejt9gomb2.setBorder(null);
			selejt9gomb2.setMinimumSize(new Dimension(10, 40));
			selejt9gomb2.setMaximumSize(new Dimension(40, 80));
			selejt9gomb2.setPreferredSize(new Dimension(20, 60));
			GridBagConstraints gbc_selejt9gomb2 = new GridBagConstraints();
			gbc_selejt9gomb2.fill = GridBagConstraints.BOTH;
			gbc_selejt9gomb2.insets = new Insets(0, 5, 5, 5);
			gbc_selejt9gomb2.ipady = (int) height / 79;
			gbc_selejt9gomb2.gridx = 3;
			gbc_selejt9gomb2.gridy = 6;
			add(selejt9gomb2, gbc_selejt9gomb2);
		}
		{
			...
			chkDonto.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkDonto.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!donto1Rajt.getText().equals("")) a1 = Integer.parseInt(donto1Rajt.getText());
						if(!donto3Rajt.getText().equals("")) a2 = Integer.parseInt(donto3Rajt.getText());
						if(!donto2Rajt.getText().equals("")) b1 = Integer.parseInt(donto2Rajt.getText());
						if(!donto4Rajt.getText().equals("")) b2 = Integer.parseInt(donto4Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkDonto.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkDonto.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
		...
		}
		{
			...
			gbc_gyoztes.gridx = 21;
			gbc_gyoztes.gridy = 7;
			add(gyoztes, gbc_gyoztes);
			gyoztes.setColumns(10);
		}
		{
			selejt10Rajt = new JTextField();
			selejt10Rajt.setFont(new Font("Tahoma", Font.PLAIN, 36));
			selejt10Rajt.setEditable(false);
			selejt10Rajt.setColumns(3);
			selejt10Rajt.setBorder(null);
			GridBagConstraints gbc_selejt10Rajt = new GridBagConstraints();
			gbc_selejt10Rajt.insets = new Insets(0, 0, 5, 5);
			gbc_selejt10Rajt.fill = GridBagConstraints.BOTH;
			gbc_selejt10Rajt.gridx = 0;
			gbc_selejt10Rajt.gridy = 8;
			add(selejt10Rajt, gbc_selejt10Rajt);
		}
		{
			selejt10 = new JTextField();
			selejt10.setFont(new Font("Tahoma", Font.PLAIN, 36));
			selejt10.setEditable(false);
			selejt10.setBorder(null);
			selejt10.setMaximumSize(new Dimension(200, 100));
			selejt10.setMinimumSize(new Dimension(10, 10));
			selejt10.setPreferredSize(new Dimension(100, 60));
			selejt10.setText("10");
			GridBagConstraints gbc_selejt10 = new GridBagConstraints();
			gbc_selejt10.fill = GridBagConstraints.BOTH;
			gbc_selejt10.insets = new Insets(0, 0, 5, 5);
			gbc_selejt10.ipady = (int) height / 79;
			gbc_selejt10.gridx = 1;
			gbc_selejt10.gridy = 8;
			add(selejt10, gbc_selejt10);
			selejt10.setColumns(10);
		}
		{
			selejt10gomb1 = new MyLabel("");
			selejt10gomb1.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) {
					if (!selejt10gomb2.isSelected()) {
						selejt10gomb1.setSelected();
						dpanel.switchNumbers();
						if (selejt10gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt10Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt10Rajt.getText()), 0);
						}
					}
				}
			});
			selejt10gomb1.setOpaque(true);
			selejt10gomb1.setBackground(Color.LIGHT_GRAY);
			selejt10gomb1.setBorder(null);
			selejt10gomb1.setMinimumSize(new Dimension(10, 40));
			selejt10gomb1.setMaximumSize(new Dimension(40, 80));
			selejt10gomb1.setPreferredSize(new Dimension(20, 60));
			GridBagConstraints gbc_selejt10gomb1 = new GridBagConstraints();
			gbc_selejt10gomb1.fill = GridBagConstraints.BOTH;
			gbc_selejt10gomb1.insets = new Insets(0, 5, 5, 5);
			gbc_selejt10gomb1.ipady = (int) height / 79;
			gbc_selejt10gomb1.gridx = 2;
			gbc_selejt10gomb1.gridy = 8;
			add(selejt10gomb1, gbc_selejt10gomb1);
		}
		{
			selejt10gomb2 = new MyLabel("");
			selejt10gomb2.addMouseListener(new MouseAdapter() {
				@Override
				public void mousePressed(MouseEvent e) {
					if (selejt10gomb1.isSelected()) {
						selejt10gomb2.setSelected();
						if (selejt10gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt10Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 1, 3, Integer.parseInt(selejt10Rajt.getText()));
							negyed3Rajt.setText(selejt10Rajt.getText());
							negyed3.setText(selejt10.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt10Rajt.getText()), 1);
						}
					}
			...
			selejt10gomb2.setOpaque(true);
			selejt10gomb2.setBackground(Color.LIGHT_GRAY);
			selejt10gomb2.setBorder(null);
			selejt10gomb2.setMinimumSize(new Dimension(10, 40));
			selejt10gomb2.setMaximumSize(new Dimension(40, 80));
			selejt10gomb2.setPreferredSize(new Dimension(20, 60));
			GridBagConstraints gbc_selejt10gomb2 = new GridBagConstraints();
			gbc_selejt10gomb2.fill = GridBagConstraints.BOTH;
			gbc_selejt10gomb2.insets = new Insets(0, 5, 5, 5);
			gbc_selejt10gomb2.ipady = (int) height / 79;
			gbc_selejt10gomb2.gridx = 3;
			gbc_selejt10gomb2.gridy = 8;
			add(selejt10gomb2, gbc_selejt10gomb2);
		}
		{
			label_1 = new JLabel("");
			...
			chkSelejt3.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent arg0) {
					if (chkSelejt3.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!selejt10Rajt.getText().equals("")) a1 = Integer.parseInt(selejt10Rajt.getText());
						if(!selejt5Rajt.getText().equals("")) a2 = Integer.parseInt(selejt5Rajt.getText());
						if(!selejt3Rajt.getText().equals("")) b1 = Integer.parseInt(selejt3Rajt.getText());
						if(!selejt8Rajt.getText().equals("")) b2 = Integer.parseInt(selejt8Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkSelejt3.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkSelejt3.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
				...
				public void mousePressed(MouseEvent e) {
					if (!negyed3gomb2.isSelected()) {
						...
						if (negyed3gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed3Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed3Rajt.getText()), 0);
						}
					}
				}
			});
			...
			negyed3gomb2.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					if (negyed3gomb1.isSelected()) {
						...
						if (negyed3gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed3Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 2, 4, Integer.parseInt(negyed3Rajt.getText()));
							elodonto2Rajt.setText(negyed3Rajt.getText());
							elodonto2.setText(negyed3.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed3Rajt.getText()), 1);
						}
					}
		...
		}
		{
			...
			gbc_selejt2Rajt.gridx = 10;
			gbc_selejt2Rajt.gridy = 9;
				...
				public void mousePressed(MouseEvent e) {
					if (selejt3gomb1.isSelected()) {
						...
						if (selejt3gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 3, Integer.parseInt(selejt3Rajt.getText()));
							negyed3Rajt.setText(selejt3Rajt.getText());
							negyed3.setText(selejt3.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt3Rajt.getText()), 1);
						}
					}
		...
		}
		{
			...
			chkElo2.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkElo2.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!selejt2Rajt.getText().equals("")) a1 = Integer.parseInt(selejt2Rajt.getText());
						if(!donto1Rajt.getText().equals("")) a2 = Integer.parseInt(donto1Rajt.getText());
						if(!elodonto2Rajt.getText().equals("")) b1 = Integer.parseInt(elodonto2Rajt.getText());
						if(!donto2Rajt.getText().equals("")) b2 = Integer.parseInt(donto2Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkElo2.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkElo2.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
			...
			gbc_chkElo2.gridx = 11;
			gbc_chkElo2.gridy = 10;
			...
			chkNegyed2.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkNegyed2.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!negyed3Rajt.getText().equals("")) a1 = Integer.parseInt(negyed3Rajt.getText());
						if(!elodonto1Rajt.getText().equals("")) a2 = Integer.parseInt(elodonto1Rajt.getText());
						if(!negyed4Rajt.getText().equals("")) b1 = Integer.parseInt(negyed4Rajt.getText());
						if(!selejt1Rajt.getText().equals("")) b2 = Integer.parseInt(selejt1Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkNegyed2.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkNegyed2.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
		...
		}
		{
			...
			gbc_elodonto2Rajt.gridx = 10;
			gbc_elodonto2Rajt.gridy = 11;
				...
				public void mousePressed(MouseEvent e) {
					if (selejt5gomb1.isSelected()) {
						...
						if (selejt5gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 4, Integer.parseInt(selejt5Rajt.getText()));
							negyed4Rajt.setText(selejt5Rajt.getText());
							negyed4.setText(selejt5.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt5Rajt.getText()), 1);
						}
					}
			...
			chkSelejt4.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkSelejt4.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!selejt5Rajt.getText().equals("")) a1 = Integer.parseInt(selejt5Rajt.getText());
						if(!negyed1Rajt.getText().equals("")) a2 = Integer.parseInt(negyed1Rajt.getText());
						if(!selejt8Rajt.getText().equals("")) b1 = Integer.parseInt(selejt8Rajt.getText());
						if(!negyed2Rajt.getText().equals("")) b2 = Integer.parseInt(negyed2Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkSelejt4.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkSelejt4.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
				...
				public void mousePressed(MouseEvent e) {
					if (!negyed4gomb2.isSelected()) {
						...
						if (negyed4gomb1.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed4Rajt.getText()), 1);
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed4Rajt.getText()), 0);
						}
					}
				}
			});
			...
			negyed4gomb2.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					if (negyed4gomb1.isSelected()) {
						...
						if (negyed4gomb2.isSelected()) {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed4Rajt.getText()), 2);
							new DbFunctions().nextDonto(kategoria, 2, 4, Integer.parseInt(negyed4Rajt.getText()));
							elodonto2Rajt.setText(negyed4Rajt.getText());
							elodonto2.setText(negyed4.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 1, Integer.parseInt(negyed4Rajt.getText()), 1);
						}
					}
			...
			chkHarmadik.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					if (chkHarmadik.isSelected()) {
						int a1 = 0, a2 = 0, b1 = 0, b2 = 0;
						if(!donto3Rajt.getText().equals("")) a1 = Integer.parseInt(donto3Rajt.getText());
						if(!donto4Rajt.getText().equals("")) b1 = Integer.parseInt(donto4Rajt.getText());
						Main.mf.setDisplayNext(a1,a2,b1,b2);
						dp.setNum(a1, b1);
					}
				}
			});
			chkHarmadik.setSelectedIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/p.png")));
			chkHarmadik.setIcon(new ImageIcon(FinalsPanel10man.class.getResource("/Images/x.png")));
		...
		}
		{
			...
			gbc_selejt8.insets = new Insets(0, 0, 0, 5);
		...
		}
		{
			...
			gbc_selejt8gomb1.insets = new Insets(0, 5, 0, 5);
		...
		}
		{
				...
				public void mousePressed(MouseEvent e) {
					if (selejt8gomb1.isSelected()) {
						...
						if (selejt8gomb2.isSelected()) {
							...
							new DbFunctions().nextDonto(kategoria, 1, 4, Integer.parseInt(selejt8Rajt.getText()));
							negyed4Rajt.setText(selejt8Rajt.getText());
							negyed4.setText(selejt8.getText());
						} else {
							new DbFunctions().updateDonto(kategoria, 0, Integer.parseInt(selejt8Rajt.getText()), 1);
						}
					}
			...
			gbc_selejt8gomb2.insets = new Insets(0, 5, 0, 5);
	...
	public void loaddata(int category) {
		...
		selejt9gomb1.setSelected(false);
		selejt9gomb2.setSelected(false);
		selejt10gomb1.setSelected(false);
		selejt10gomb2.setSelected(false);
		...
		for (int i = 0; i < lista.size(); i++) {
			...
			case 3: {
				selejt9Rajt.setText(Integer.toString(d.getRajt()));
				selejt9.setText(d.getNev());
				if (d.getNyert() > 1) {
					selejt9gomb2.setSelected(true);
					selejt9gomb1.setSelected(true);
				} else if (d.getNyert() > 0) {
					selejt9gomb2.setSelected(false);
					selejt9gomb1.setSelected(true);
				} else {
			...
			case 4: {
				selejt10Rajt.setText(Integer.toString(d.getRajt()));
				selejt10.setText(d.getNev());
				if (d.getNyert() > 1) {
					selejt10gomb2.setSelected(true);
					selejt10gomb1.setSelected(true);
				} else if (d.getNyert() > 0) {
					selejt10gomb2.setSelected(false);
					selejt10gomb1.setSelected(true);
				} else {
		...
		lista = new DbFunctions().selectDonto(kategoria, 1);
	...
	public void paintComponent(Graphics g) {
		...
		// SEJEJTEZO 7-6
		x1 = selejt7gomb2.getX() + selejt7gomb2.getWidth();
		y1 = selejt7gomb2.getY() + selejt7gomb2.getHeight() / 2;
		...
		g2.drawLine(x1, y1, x2, y1);
		y2 = selejt9gomb2.getY() + selejt9gomb2.getHeight() / 2;
		g2.drawLine(x1, y2, x2, y2);
		g2.drawLine(x2, y1, x2, y2);
		...
		// SEJEJTEZO 10-3
		x1 = selejt10gomb2.getX() + selejt10gomb2.getWidth();
		y1 = selejt10gomb2.getY() + selejt10gomb2.getHeight() / 2;
		...
		g2.drawLine(x1, y1, x2, y1);
		y2 = selejt8gomb2.getY() + selejt8gomb2.getHeight() / 2;
		g2.drawLine(x1, y2, x2, y2);
		g2.drawLine(x2, y1, x2, y2);
